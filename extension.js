            ...
            game.import('character', function (lib, game, ui, get, ai, _status) {
                const QQQ = {
                    ...
                    translate: {
                        ...
                        HL_yelongliezhan_info: '你的红色【杀】视为无次数限制的火属性【杀】;当你造成火属性伤害后,目标角色获得一枚『烧伤』标记,然后你弃置一张牌.',
                        ...
                        HL_gongfubishui_info: '①当你受到伤害时,若此伤害为火属性,则此伤害对你无效;若此伤害不为冰属性,则此伤害减一,然后你回复一点体力值(若你的体力值已达上限,则改为你获得一点护甲值);②你免疫〖烧伤〗效果.',
                        HL_shaoEGO: '邵E·G·O',
                        HL_shaoEGO_info: '你每使用或打出一张牌/造成一次伤害,获得一枚/三枚『情感』标记(上限为15);你每拥有三枚此标记,你使用杀的次数+1.',
                        HL_shaoEGO_1: '邵E.G.O',
                        HL_shaoEGO_1_info: '任意角色的回合开始或结束,若情感标记大于12,获得以下技能',
                        HL_jiaotu: '椒图镇邪',
                        HL_jiaotu_info: '当你成为敌方角色使用牌的目标时,若此牌有点数且为实体牌:(你与其使用的牌拼点,若你赢,令此牌无效,然后令其获得三枚烧伤标记).否则令此牌无效',
                        HL_bian: '狴犴争讼',
                        HL_bian_info: '敌方角色的回合开始时,令拥有烧伤标记的敌方角色受到x点伤害(x为其烧伤标记数量),然后你回复等量体力(若体力已达到上限,则改为获得等量护甲)',
                        HL_liwen: '螭吻吞脊',
                        ...
                        HL_taotie: '饕餮饗食',
                        HL_taotie_info: '当你受到伤害时,你弃置一张牌,令此伤害减x(x为场上烧伤标记数量);当你流失体力时,令其无效,然后你增加一点体力上限',
                        HL_bili: '赑屃负礎',
